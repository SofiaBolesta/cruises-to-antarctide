...
var _burgerMenu = require("./burger-menu");
var _menuScroll = require("./menu-scroll");
var _phoneMask = require("./phone-mask");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  (0, _burgerMenu.openMenuMobile)();
  (0, _iosVhFix.iosVhFix)();
  (0, _menuScroll.menuScroll)();
...
},{"./burger-menu":1,"./menu-scroll":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./phone-mask":13,"./utils/ios-vh-fix":16}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.menuScroll = void 0;
var menuAdvantages = document.querySelector('.menu__advantages');
var menuFeatures = document.querySelector('.menu__features');
var menuContacts = document.querySelector('.menu__contacts');
var blockFocusAdvantages = document.querySelector('.advantages');
var blockFocusFeatures = document.querySelector('.features');
var blockFocusContacts = document.querySelector('.contacts');
var menuScroll = function menuScroll() {
  menuAdvantages.addEventListener('click', function () {
    blockFocusAdvantages.scrollIntoView({
      behavior: 'smooth'
    });
  });
  menuFeatures.addEventListener('click', function () {
    blockFocusFeatures.scrollIntoView({
      behavior: 'smooth'
    });
  });
  menuContacts.addEventListener('click', function () {
    blockFocusContacts.scrollIntoView({
      behavior: 'smooth'
    });
  });
};
...
exports.initPhoneMask = initPhoneMask;
